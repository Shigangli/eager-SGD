...
#from official.resnet import resnet_run_loop_sgd_mpi_imagenet as resnet_run_loop
from official.resnet import resnet_run_loop_hvd_imagenet_300 as resnet_run_loop
