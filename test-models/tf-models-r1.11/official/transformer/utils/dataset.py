...
def _filter_max_length(example, max_length=1024):
...
def _batch_examples(dataset, batch_size, max_length):
  ...
  #bucket_batch_sizes = [128 if 128*x <= batch_size else batch_size // x for x in buckets_max]
  bucket_batch_sizes = [128 for x in buckets_max]
